# docker-laravel-postgres11-nginx
...
+ default standard password postgres can be seen in the .env file
...
#Credit
this docker modified by https://github.com/thayronarrais/docker-laravel-postgres-nginx
